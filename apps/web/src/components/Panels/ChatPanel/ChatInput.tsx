  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="w-full">
        <div
          className={`rounded-2xl border p-3 transition-colors ${isDragOver ? 'border-border bg-info-bg' : 'border-border bg-card'}`}
        >
              ...
              {selectionAttachment &&
                (() => {
                  ...
                  if (sourceNodeId) {
                    tooltipParts.push(
                      <div key="src" className="flex items-center gap-1">
                        ...
                        <span className="[&>div]:text-surface-invert-foreground [&>div]:border-white/30 [&>div:hover]:bg-white/10">
                  ...
                  const tile = (
                    ...
                    >
                      <div className="bg-surface-subtle flex h-12 w-12 items-center justify-center rounded-md px-1">
                        <span className="text-muted-foreground line-clamp-3 w-full text-center text-[8px] leading-tight">
                          {previewText}
                        </span>
                      </div>
                      <IconButton
                        ...
                        className="text-surface-invert-foreground rounded-full bg-black/50 p-0.5 enabled:hover:bg-black/70"
          ...
          <textarea
            ...
            disabled={disabled}
            rows={2}
            className="text-primary placeholder:text-text-muted w-full resize-none bg-transparent text-sm focus:outline-none disabled:cursor-not-allowed"
          />
