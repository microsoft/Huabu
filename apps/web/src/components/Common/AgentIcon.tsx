 ...
 * agents. It renders one of four hand-drawn "basic shapes" (circle, diamond,
 * spark, five-petal flower) filled with one of four fixed brand colors, plus
 * an optional subtle face.
 *
