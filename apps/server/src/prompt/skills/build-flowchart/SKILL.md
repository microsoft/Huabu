...
description: Step-by-step guide for building flowcharts, research roadmaps, knowledge maps, and process diagrams with row-based tracks, sub-layers, and color-coded grouping.
appliesTo: [operate]
triggers: [flowchart, roadmap, knowledge map, process diagram]
version: 1
---

# Build Flowchart / Research Roadmap

Row-based track layout: each track = horizontal theme with optional sub-layer below. See the host system prompt's "Layout strategies" section for coordinate basics.
