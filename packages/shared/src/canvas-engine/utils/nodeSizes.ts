...
const DEFAULT_SIZES: Record<string, NodeSize> = {
  text: { width: 200 },
  // Note nodes auto-size by content height. The nominal height includes the
  // empty-body minimum, title row, and shell at the default width.
  note: { width: 400, height: 88 },
