...
1. **让其它 agent 能操作 Huabu**，对应 [huabu-acp-client-plan.md](./huabu-acp-client-plan.md) 的镜像方向；
...
## 9. 跟 huabu-acp-client-plan 的关系

[huabu-acp-client-plan.md](./huabu-acp-client-plan.md) 描述的方向是：
...
- [huabu-acp-client-plan.md](./huabu-acp-client-plan.md)：Huabu 调外部 agent；本设计是镜像方向（外部 agent 调 Huabu），互不冲突。
