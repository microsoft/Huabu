...
| [pi-harness-driver-refactor-plan.md](./proposals/pi-harness-driver-refactor-plan.md) | Draft                                           | Standard Agenetes pi harness driver plus Huabu built-in agent refactor from threaded Job replay to conversation-native Deployment. |
