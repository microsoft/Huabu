...
| [agent-request-render-resolution.md](./proposals/agent-request-render-resolution.md)                 | Draft                                           | Resolve request rendering through per-run, per-driver, per-request-type, and JSON fallback layers without changing logs.       |
