...
| [agent-request-render-resolution.md](./proposals/agent-request-render-resolution.md)                 | Draft                                           | Separate durable source requests from pre-rendered harness input through an explicit `AgentSubmission`.                        |
