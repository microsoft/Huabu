...
| [agent-request-render-resolution.md](./proposals/agent-request-render-resolution.md)                 | Draft                                           | Extend `{ type, content }` into a generic durable submission with optional canonical harness inputs.                           |
