...
| [managed-agent-teams.md](./proposals/managed-agent-teams.md)                                         | Draft                                           | Redesign Agent Teams as a Huabu-managed discovery, configuration, preparation, and runtime experience.                         |
