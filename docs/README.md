...
| [multi-backend-storage.md](./proposals/multi-backend-storage.md)                                                     | Partly shipped | Phases 1–6 implemented, including Postgres, Azure Blob, and async agent persistence.   |
