...
| [managed-acp-harness.md](./proposals/managed-acp-harness.md)                                         | Draft                                           | Standard ACP preamble and launch semantics plus managed harness configuration isolation from project working directories.      |
