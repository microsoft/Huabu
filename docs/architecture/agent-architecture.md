...
- If an ACP turn ends without an `agent_message_chunk`, the driver preserves its tool, thinking, and terminal events and completes with an empty message; it never synthesizes diagnostic prose into the assistant transcript.
