...
| Legacy memory migration                                 | [storage/migrate-memory.ts](../../apps/server/src/modules/storage/migrate-memory.ts)                                                                                                                                                                                                                                |
...
- Legacy `<canvas>/memory/preferences.md` is `mv`-migrated once at startup to `.memory/canvas.md` by `migrateLegacyMemory()`.
